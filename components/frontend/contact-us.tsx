            ...
            <form className="grid gap-4" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="mt-2 flex rounded-md shadow-sm">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="block rounded-l-md border border-gray-300 bg-white pl-3 pr-10 py-2 text-sm focus:border-indigo-600 focus:ring-2 focus:ring-indigo-100 appearance-none overflow-y-auto"
                        style={{
                          maxHeight: "200px", // about 8 options
                        }}
                      >
                        {countries.map((countries) => (
                          <option
                            key={countries.countryCode}
                            value={countries.phoneCode}
                          >
                            {countries.flag} {countries.phoneCode}
                          </option>
                        ))}
                      </select>
                ...
                <div>
                  ...
                  <div className="relative mt-2">
                    ...
                    >
                      ...
                      {countries.map((countries) => (
                        <option key={countries.countryCode} value={countries.countryCode}>
                          {countries.label}
                        </option>
                      ))}
                    </select>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    {...register("schoolPage", {
                      required: "School website is required",
                    })}
